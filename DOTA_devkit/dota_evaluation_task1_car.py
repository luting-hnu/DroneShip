...
def parse_args():
    ...
    parser.add_argument('--detpath',
                        default='/server08/ljc/OBB/yolov5_obb-master/runs/val/dronevehicle/I_trans/last_predictions_Txt/Task1_{:s}.txt',
                        help='test config file path')
    parser.add_argument('--annopath',
                        default='/server08/ljc/OBB/yolov5_obb-master/dataset/DroneVehicle/labelTxt/test/ir1/{:s}.txt',
                        help='checkpoint file')
    parser.add_argument('--imagesetfile',
                        default='/server08/ljc/OBB/yolov5_obb-master/dataset/DroneVehicle/imgnamefile.txt',
                        help='checkpoint file')
    parser.add_argument('--annopath_xml',
                        default='/server08/ljc/OBB/yolov5_obb-master/dataset/DroneVehicle/images/test/testlabelr/{:s}.xml',
                        help='checkpoint file')
...
def main():
    ...
    # For DroneVehicle
    # classnames =[
# 'General-Cargo-Ship' , 'Container-Ship' , 'Empty-Cargo-Ship' , 'Bulk-Carrier' , 'Oil-Tanker' , 'Chemical-Tanker' , 'Passenger-Ship' , 'Engineering-Ship' , 'Fishing-Vessel' , 'Tug'
# ]
