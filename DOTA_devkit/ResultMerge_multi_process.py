...
def parse_args():
    ...
    parser.add_argument('--scrpath', default='/home/server08/ljc/yolov5_obb-master/runs/val/exp9/last_predictions_Txt', help='test config file path')
    parser.add_argument('--dstpath', default='/home/server08/ljc/yolov5_obb-master/runs/val/exp9/last_predictions_Txt_M', help='checkpoint file')
