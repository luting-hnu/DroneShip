...
class LoadMultiModalImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            # Load image
            img_rgb, img_ir, (h0, w0), (h, w), labels_rgb, label_ir = load_image_rgb_ir(self, index)
            ...
            if labels.size:  # normalized xywh to pixel xyxy format
                ...
                labels[:, [1, 3, 5, 7]] = labels_rgb[:, [1, 3, 5, 7]] * ratio[0] + pad[0]
                labels[:, [2, 4, 6, 8]] = labels_rgb[:, [2, 4, 6, 8]] * ratio[1] + pad[1]
            if self.augment:
                img_rgb, img_ir, labels_rgb, labels_ir = random_perspective_rgb_ir(img_rgb, img_ir, labels, labels,
