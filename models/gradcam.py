...
class YOLOV5GradCAM:
    ...
    def forward(self, ir_img,vis_img, class_idx=True):
        """
        Args:
        ...
        preds, logits = self.model(ir_img,vis_img)
    ...
    def __call__(self, ir_img,vis_img):
        return self.forward(ir_img,vis_img)
